...
namespace ToolBaoCao.Areas.Admin.Controllers
{
    public class DMTinhController : ControllerCheckLogin
    {
        ...
        public ActionResult Index()
        {
            try
            {
                ViewBag.data = AppHelper.dbSqliteMain.getDataTable("SELECT * FROM dmtinh ORDER BY tt");
            }
        ...
        public ActionResult Update()
        {
            ...
            try
            {
                ...
                if (id != "")
                {
                    ...
                    var data = AppHelper.dbSqliteMain.getDataTable($"SELECT * FROM dmtinh WHERE idtinh='{id}'");
